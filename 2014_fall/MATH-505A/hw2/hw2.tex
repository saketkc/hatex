...
\newcommand{\hmwkDueDate}{Friday,\ September \ 4,\ 2014} % Due date
		...
		\end{homeworkSection}
			...
			\begin{homeworkSection}{(5)} % Section within problem
				...
				\problemAnswer{ % Answer
					...
					For which event C, are A and B(for all A,B)  independent iff they are cconditionaly independent given C: $?$
					
					If $A,B$ are independent : $P(A|B)=P(A)$
					
					Given: $P(A, B |C) = P(A|C)P(B|C)$  for all A,B.
