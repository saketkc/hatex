...
\begin{homeworkProblem}[Exercise \# 1] % Custom section title


\begin{homeworkSection}{(1a)} % Section within problem
...
\begin{homeworkSection}{(1b)} % Section within problem
\problemAnswer{ % Answer
...
\end{align}
The above equation is a audratic and will have two solutions,
