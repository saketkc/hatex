...
\begin{homeworkProblem}[Problem 5]
	...
	\end{tabular}
	\problemAnswer{
		As ecident from the plots above, increasing $K$ results in more smooth boundaries. This is expected,because $k$ increasing leads to more neihbors being weighted for deciding the final label, and this will often involve neighbors that are far apart, thus creating the soft boundaries}
	\end{homeworkSection}	
