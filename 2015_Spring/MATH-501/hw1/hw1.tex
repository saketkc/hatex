...
\problemAnswer{
	$c_0=\frac{a+b}{2} =  0.1$ and $f(c_0)=0.0997$ $\implies f(c_0)f(b)<0$
	Hence $c_1=\frac{c_0+b}{2}=2.5$ and $f(c_1)=1.2036$ $\implies f(c_1)f(b)<0$\\
	Hence $c_2=\frac{c_1+b}{2}=3.85$ and again $f(c_2)f(b)<0$ so\\
	$c_3=\frac{c_2+b}{2}=4.475$ and $f(c_3)=1.3509$ and still $f(c_3)f(b)<0$
