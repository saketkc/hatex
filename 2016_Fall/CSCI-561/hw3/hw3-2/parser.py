...
class BaseNode(object):
    ...
    def __eq__(self, other):
        if type(other) != type(self):
            return False
        #print(self.flag == other.flag, self.params == other.params, self.predicate == other.predicate)
        return self.flag == other.flag and self.predicate == other.predicate and self.params== other.params
