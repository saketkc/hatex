...
print(xtable(model2.summary, caption= "Model 2 Summary"))
```
...
Thus, $\hat{\beta}$: `r print(kable(beta2.adj.constant))`
and $\sigma^2$: `r print(sigma2.squared)`
...
95% bonferroni CI for $\beta_0,\beta_1,\beta_2, \beta_3$: 

```{r} 
print(kable(CI.bonferroni))
```
